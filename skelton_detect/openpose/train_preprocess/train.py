...
if __name__ == '__main__':
    #============================================
    prepared_train_labels = "prepare_train_annotation.pkl"  #准备好的annotations路径
    train_images_folder = "../datasets/coco2017/train2017"    #COCO训练图片文件夹路径
    ...
    val_images_folder = "../datasets/coco2017/val2017"                          #COCO验证集图片路径
